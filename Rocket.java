 ...
 */
  public class Rocket extends SmoothMover
     ...
     */
    /**
     * checking if the keys have been pressed to move the rocket/ start proton wave/ fire bullets 
     * 
     * @param There are no parameters
     * @return Nothing is returned
     */
     ...
     */
    /**
     * starts proton wave once method is callled 
     * 
     * @param There are no parameters
     * @return Nothing is returned
     */
     ...
     */
    /**
     * setting the rocket image (with/without booster)
     * 
     * @param boolean booster on 
     * @return boolean value
     */
    private void ignite(boolean boosterOn)
    {
        GreenfootImage rocket = new GreenfootImage("rocket.png");
        GreenfootImage thrust = new GreenfootImage("rocketWithThrust.png");
        if(boosterOn = true)
        {
            setImage(thrust);
     ...
     */
    /**
     * checks if the rocket/asteroids are touching 
     * 
     * @param There are no parameters
     * @return Nothing is returned
     */
